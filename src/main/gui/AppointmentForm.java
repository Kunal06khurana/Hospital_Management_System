...
public class AppointmentForm extends JFrame {
    ...
    private void handleNavClick(ActionEvent e) {
        ...
        switch (command) {
            case "Dashboard":
                new MainDashboard(usernameField.getText()).setVisible(true);
                dispose();
                break;
            case "Manage Patients":
                new PatientForm(usernameField.getText()).setVisible(true);
                dispose();
                break;
            case "Manage Doctors":
            ...
            case "Manage Appointments":
                new AppointmentForm(usernameField.getText()).setVisible(true);
                dispose();
                break;
            case "Manage Billings":
                new BillingForm(usernameField.getText()).setVisible(true);
                dispose();
                break;
            case "Logout":
